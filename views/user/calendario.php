                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">    
                                <div class="form-group">
                                    ...
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input type="text" placeholder="08:00" class="form-control" id="inputHoraFinal" name="hora_final" required>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="inputDescripcion" name="descripcion" required></textarea>
                                </div>
                            </div>       
